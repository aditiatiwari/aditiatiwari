# Hi, I'm Aditi! 
**Budget & Financial Analyst II - University of Utah | Corporate Finance & Financial Planning and Analysis | Risk Management | MS in Finance (MSF) @ Babson College | Ex-Interactive Brokers**
...
<a href="mailto:adititiwariat8@gmail.com"> <img src="https://img.shields.io/badge/Email-D14836?style=for-the-badge&logo=gmail&logoColor=white" alt="Email Badge" /></a>
...
As a graduate with an MS in Finance from Babson College, I leverage my knowledge and skills to tackle financial challenges, drive corporate growth, and contribute to financial excellence. I am committed to lifelong learning and always seeking opportunities to develop my expertise.
...
- ### ***GoPro Valuation Model***
  ...
  **Overview:**
  ...
  The model also provides valuable insights into GoPro's value drivers. By breaking down the components of the valuation, I've identified which factors have the most significant impact on the company's overall value. This information can guide management in focusing their efforts on areas that will create the most shareholder value.
...
- ### ***Comparable Public Companies Model for Apparel Retail industry***
  ...
  **Project Significance:**
  ...
  By creating this comp model, I've provided a powerful tool for analyzing the competitive landscape of the apparel retail industry. It serves as a foundation for more in-depth financial analysis, supports valuation exercises, and aids in identifying potential investment opportunities or risks within the sector. The model's flexibility also allows for easy updates as new financial data becomes available, ensuring its ongoing relevance and utility in understanding this important segment of the retail market.
